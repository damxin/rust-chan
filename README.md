...
DRAWLINE(FB==1,IF(POLE_VALUE<>DRAWNULL,POLE_VALUE,L),FS==+1,IF(POLE_VALUE<>DRAWNULL,POLE_VALUE,H),0), LINETHICK2, COLORYELLOW;
DRAWLINE(FS==1,IF(POLE_VALUE<>DRAWNULL,POLE_VALUE,H),FB==1,IF(POLE_VALUE<>DRAWNULL,POLE_VALUE,L),0), LINETHICK2, COLORYELLOW;
