...
DRAWLINE(FX==-1,IF(POLE_VALUE<>DRAWNULL,POLE_VALUE,L),FX==+1,IF(POLE_VALUE<>DRAWNULL,POLE_VALUE,H),0), LINETHICK1, COLORYELLOW, DOTLINE;
DRAWLINE(FX==1,IF(POLE_VALUE<>DRAWNULL,POLE_VALUE,H),FX==-1,IF(POLE_VALUE<>DRAWNULL,POLE_VALUE,L),0), LINETHICK1, COLORYELLOW, DOTLINE;

DRAWLINE(FB==1,IF(POLE_VALUE<>DRAWNULL,POLE_VALUE,L),FS==+1,IF(POLE_VALUE<>DRAWNULL,POLE_VALUE,H),0), LINETHICK2, COLORYELLOW, DOTLINE;
DRAWLINE(FS==1,IF(POLE_VALUE<>DRAWNULL,POLE_VALUE,H),FB==1,IF(POLE_VALUE<>DRAWNULL,POLE_VALUE,L),0), LINETHICK2, COLORYELLOW, DOTLINE;
...
{
DRAWLINE(FRAC=-1,ZEN2.POLE_VALUE,FRAC=+1,ZEN2.POLE_VALUE,0), COLORGREEN;
DRAWLINE(FRAC=+1,ZEN2.POLE_VALUE,FRAC=-1,ZEN2.POLE_VALUE,0), COLORGREEN;
}
...
DRAWLINE(DUAN1=-1,ZEN2.POLE_VALUE,DUAN1=+2,ZEN2.POLE_VALUE,0), LINETHICK3, COLORYELLOW;
DRAWLINE(DUAN1=+1,ZEN2.POLE_VALUE,DUAN1=-2,ZEN2.POLE_VALUE,0), LINETHICK3, COLORYELLOW;
